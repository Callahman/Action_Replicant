...
TEACHER_DATA_DIR = DATA_DIR / "Teacher"
...
STUDENT_DATA_DIR = STUDENT_DIR / "data"
STUDENT_MODELS_DIR = STUDENT_DATA_DIR / "models"

# Auto-create data dirs that need to exist
_dirs_to_create = [
    DATA_DIR, IMAGE_DIR, PICKLE_DIR, BBOX_DIR, TEACHER_DATA_DIR, PATCH_DIR, PATCH_DATASET_DIR, DATASET_DIR,
    OUTPUT_DIR, TEST_DIR, TRAIN_DIR, VALID_DIR,
    PATCH_OUTPUT_DIR, PATCH_TEST_DIR, PATCH_TRAIN_DIR, PATCH_VALID_DIR,
    STUDENT_DATA_DIR, STUDENT_MODELS_DIR
    ]
